...
const BubbleCheckbox: React.FC<BubbleCheckboxProps> = ({
  checked = false,
  onChange,
  label,
  className,
  ...
  return (
    <StyledWrapper className={className}>
      ...
      {label && <span className="bubble-label">{label}</span>}
    </StyledWrapper>
  );
};
...
const StyledWrapper = styled.div`
  ...
  .bubble {
    ...
    transition-timing-function:
      ease-in-out, ease-in-out, var(--bubbleTiming, ease-in-out), var(--bubbleTiming, ease-in-out);
  ...
  .bubble:after {
    ...
    display: block;
    position: absolute;
    transition-timing-function: var(--bubbleTiming, ease-in-out);
  }
