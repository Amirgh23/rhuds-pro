...
export interface ColdWarToggleSwitchProps {
  label?: string;
  checked?: boolean;
...
export const ColdWarToggleSwitch: React.FC<ColdWarToggleSwitchProps> = ({
  label,
  ...
  const sizeMap = {
    sm: { width: '32px', height: '16px', fontSize: '12px', thumbSize: '12px' },
    md: { width: '40px', height: '20px', fontSize: '14px', thumbSize: '16px' },
    lg: { width: '48px', height: '24px', fontSize: '16px', thumbSize: '20px' },
  };
    ...
    >
      <div
        style={{
          ...
          alignItems: 'center',
          padding: '2px',
          boxShadow: checked && glow && !disabled ? `0 0 15px rgba(${rgb}, 0.6)` : 'none',
        }}
      >
        <div
          style={{
...
export default ColdWarToggleSwitch;
