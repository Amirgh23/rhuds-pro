...
export interface ColdWarNeonCheckboxProps {
  label?: string;
  checked?: boolean;
...
export const ColdWarNeonCheckbox: React.FC<ColdWarNeonCheckboxProps> = ({
  label,
        ...
        style={{
          ...
          boxShadow:
            checked && glow && !disabled
              ? `0 0 20px rgba(${rgb}, 0.8), inset 0 0 15px rgba(${rgb}, 0.4)`
              : 'none',
        }}
      >
        {checked && (
...
export default ColdWarNeonCheckbox;
