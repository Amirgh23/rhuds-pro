...
function ChartComponent({
  ...
  // Memoize default colors to prevent unnecessary recalculations
  const defaultColors = useMemo(
    () => colors || [primaryColor, secondaryColor, accentColor, '#FF6384', '#36A2EB', '#FFCE56'],
    [colors, primaryColor, secondaryColor, accentColor]
  );

  // Memoize drawing functions to prevent unnecessary recalculations
